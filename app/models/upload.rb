class Upload < RoleRecord
  ...
  validates_format_of :invited_user_email, with: /\A[A-Z0-9._%+-]+@[A-Z0-9.-]+\.[A-Z]{2,4}\z/i, allow_nil: true
  ...
  def s3_url(style_name = nil)
    AWS::S3::S3Object.url_for(asset.path(style_name), asset.bucket_name, { expires_in: Rails.configuration.teambox.amazon_s3_expiration.to_i })
  end
