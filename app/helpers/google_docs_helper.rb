module GoogleDocsHelper
  ...
  def google_docs_enabled?
    Rails.configuration.teambox.providers? and
  ...
  def google_docs_write_access_link(google_doc)
    ...
    link_to t("google_docs.google_doc.#{access}"), write_access_project_google_doc_path(project_id: google_doc.project, id: google_doc, access: access), method: :put, remote: true, class: "google_doc_write_lock"
  end
end
