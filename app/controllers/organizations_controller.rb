class OrganizationsController < ApplicationController
  ...
  before_action :load_organization, only: [ :show, :edit, :appearance, :update, :projects, :delete, :destroy, :update_appearance ]
  before_action :load_page_title, only: [ :show, :projects, :edit, :appearance, :update, :delete ]

  before_action :redirect_community, only: [ :index, :new, :create ]
