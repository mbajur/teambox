...
Feature: Create task list tempates and convert them to tasks
  ...
  Scenario: I create a task list template
    ...
    And I fill in "task_list_template[tasks_attributes][0][name]" with "Gather CVs"
    And I fill in "task_list_template[tasks_attributes][0][description]" with "Get the best 12 cadidates from Infojobs"
    And I press "Create Task List Template"
